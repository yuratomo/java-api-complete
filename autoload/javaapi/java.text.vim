...
call javaapi#class('DontCareFieldPosition', '', [
  \ ])
...
call javaapi#class('DictionaryBasedBreakIterator', '', [
...
call javaapi#class('RuleBasedBreakIterator', '', [
...
call javaapi#class('RuleBasedCollationKey', '', [
  \ javaapi#method(0,'compareTo(', 'CollationKey)', 'int'),
  \ javaapi#method(0,'equals(', 'Object)', 'boolean'),
  \ javaapi#method(0,'hashCode(', ')', 'int'),
  \ javaapi#method(0,'toByteArray(', ')', 'byte[]'),
