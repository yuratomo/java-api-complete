...
call javaapi#class('UnknownContentHandler', '', [
  \ javaapi#method(0,'getContent(', 'URLConnection) throws IOException', 'Object'),
  \ ])
...
call javaapi#class('PlainSocketImpl', '', [
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ javaapi#method(0,'setOption(', 'int, Object) throws SocketException', 'void'),
  \ javaapi#method(0,'getOption(', 'int) throws SocketException', 'Object'),
...
call javaapi#class('SocksSocketImpl', '', [
  \ ])
...
call javaapi#class('SocketPermissionCollection', '', [
...
call javaapi#class('AbstractPlainDatagramSocketImpl', '', [
  \ javaapi#method(0,'setOption(', 'int, Object) throws SocketException', 'void'),
  \ javaapi#method(0,'getOption(', 'int) throws SocketException', 'Object'),
  \ ])

call javaapi#class('AbstractPlainSocketImpl', '', [
...
call javaapi#class('DualStackPlainDatagramSocketImpl', '', [
  \ ])

call javaapi#class('DualStackPlainSocketImpl', '', [
  \ javaapi#method(0,'DualStackPlainSocketImpl(', ')', 'public'),
  \ javaapi#method(0,'DualStackPlainSocketImpl(', 'FileDescriptor)', 'public'),
  \ ])

call javaapi#class('FactoryURLClassLoader', '', [
...
call javaapi#class('SdpSocketImpl', '', [
  \ ])
...
call javaapi#class('SocketOutputStream', '', [
  \ javaapi#method(0,'getChannel(', ')', 'FileChannel'),
...
call javaapi#class('StandardProtocolFamily', '', [
...
call javaapi#class('TwoStacksPlainDatagramSocketImpl', '', [
  \ javaapi#method(0,'getOption(', 'int) throws SocketException', 'Object'),
  \ ])

call javaapi#class('TwoStacksPlainSocketImpl', '', [
