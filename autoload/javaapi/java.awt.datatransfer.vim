...
call javaapi#interface('FlavorTable', '', [
...
call javaapi#class('TextFlavorComparator', '', [
  \ javaapi#method(0,'compare(', 'Object, Object)', 'int'),
  \ ])

call javaapi#class('FlavorEvent', '', [
  \ javaapi#method(0,'FlavorEvent(', 'Clipboard)', 'public'),
  \ ])

call javaapi#interface('FlavorListener', '', [
...
call javaapi#class('UnsupportedFlavorException', '', [
