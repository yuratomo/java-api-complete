...
call javaapi#class('UnicodeScript', 'UnicodeScript>', [
...
call javaapi#class('ClassValueMap', 'Object>', [
  \ ])
...
call javaapi#class('NullInputStream', 'InputStream', [
  \ javaapi#method(0,'read(', ')', 'int'),
  \ javaapi#method(0,'available(', ')', 'int'),
  \ ])

call javaapi#class('NullOutputStream', 'OutputStream', [
  \ javaapi#method(0,'write(', 'int) throws IOException', 'void'),
  \ ])

call javaapi#class('1', 'Redirect', [
  \ javaapi#method(0,'type(', ')', 'Type'),
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ ])

call javaapi#class('2', 'Redirect', [
  \ javaapi#method(0,'type(', ')', 'Type'),
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ ])

call javaapi#class('3', 'Redirect', [
  \ javaapi#method(0,'type(', ')', 'Type'),
  \ javaapi#method(0,'file(', ')', 'File'),
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ ])

call javaapi#class('4', 'Redirect', [
  \ javaapi#method(0,'type(', ')', 'Type'),
  \ javaapi#method(0,'file(', ')', 'File'),
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ ])

call javaapi#class('5', 'Redirect', [
  \ javaapi#method(0,'type(', ')', 'Type'),
  \ javaapi#method(0,'file(', ')', 'File'),
  \ javaapi#method(0,'toString(', ')', 'String'),
  \ ])
...
call javaapi#class('CheckedEntrySet', 'String>>', [
...
call javaapi#class('CheckedKeySet', 'String>', [
...
call javaapi#class('CheckedValues', 'String>', [
...
call javaapi#class('WrappedPrintStream', 'PrintStreamOrWriter', [
  \ ])

call javaapi#class('WrappedPrintWriter', 'PrintStreamOrWriter', [
  \ ])
...
call javaapi#class('Entry', 'ThreadLocal>', [
  \ ])
...
call javaapi#class('Object', '', [
  \ javaapi#method(0,'Object(', ')', 'public'),
