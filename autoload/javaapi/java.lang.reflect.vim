...
call javaapi#class('AccessibleObject', '', [
  ...
  \ javaapi#method(0,'getAnnotation(', 'Class<T>)', '<java/lang/annotation/Annotation>T'),
...
call javaapi#class('GenericSignatureFormatError', 'ClassFormatError', [
  \ javaapi#method(0,'GenericSignatureFormatError(', ')', ''),
  \ ])
...
call javaapi#class('InvocationTargetException', 'ReflectiveOperationException', [
  \ javaapi#method(0,'InvocationTargetException(', 'Throwable)', ''),
  \ javaapi#method(0,'InvocationTargetException(', 'Throwable, String)', ''),
...
call javaapi#class('MalformedParameterizedTypeException', 'RuntimeException', [
  \ javaapi#method(0,'MalformedParameterizedTypeException(', ')', ''),
  \ ])

call javaapi#interface('Member', '', [
  \ javaapi#method(1,'PUBLIC', '', 'int'),
  \ javaapi#method(1,'DECLARED', '', 'int'),
  \ javaapi#method(0,'getDeclaringClass(', '', 'Class<?>'),
  \ javaapi#method(0,'getName(', ')', 'String'),
  \ javaapi#method(0,'getModifiers(', ')', 'int'),
  \ javaapi#method(0,'isSynthetic(', ')', 'boolean'),
...
call javaapi#class('Modifier', '', [
  \ javaapi#method(1,'PUBLIC', '', 'int'),
  \ javaapi#method(1,'PRIVATE', '', 'int'),
  \ javaapi#method(1,'PROTECTED', '', 'int'),
  \ javaapi#method(1,'STATIC', '', 'int'),
  \ javaapi#method(1,'FINAL', '', 'int'),
  \ javaapi#method(1,'SYNCHRONIZED', '', 'int'),
  \ javaapi#method(1,'VOLATILE', '', 'int'),
  \ javaapi#method(1,'TRANSIENT', '', 'int'),
  \ javaapi#method(1,'NATIVE', '', 'int'),
  \ javaapi#method(1,'INTERFACE', '', 'int'),
  \ javaapi#method(1,'ABSTRACT', '', 'int'),
  \ javaapi#method(1,'STRICT', '', 'int'),
  \ javaapi#method(0,'Modifier(', ')', ''),
...
call javaapi#class('Proxy', '', [
  \ javaapi#method(1,'getProxyClass(', 'ClassLoader, ) throws IllegalArgumentException', 'Class<?>'),
...
call javaapi#class('ReflectAccess', '', [
...
call javaapi#class('ReflectPermission', 'BasicPermission', [
  \ javaapi#method(0,'ReflectPermission(', 'String)', ''),
  \ javaapi#method(0,'ReflectPermission(', 'String, String)', ''),
  \ ])

call javaapi#interface('Type', '', [
  \ ])

call javaapi#interface('TypeVariable', 'GenericDeclaration> extends Type', [
...
call javaapi#class('UndeclaredThrowableException', 'RuntimeException', [
  \ javaapi#method(0,'UndeclaredThrowableException(', 'Throwable)', ''),
  \ javaapi#method(0,'UndeclaredThrowableException(', 'Throwable, String)', ''),
