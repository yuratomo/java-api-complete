...
call javaapi#class('ModalityType', '', [
...
call javaapi#class('ModalExclusionType', '', [
...
call javaapi#class('HeadlessException', '', [
...
call javaapi#class('AWTException', '', [
...
call javaapi#interface('LayoutManager2', '', [
...
call javaapi#class('ContainerOrderFocusTraversalPolicy', '', [
...
call javaapi#class('DefaultFocusTraversalPolicy', '', [
  \ javaapi#method(0,'DefaultFocusTraversalPolicy(', ')', 'public'),
  \ ])

call javaapi#class('DefaultKeyboardFocusManager', '', [
...
call javaapi#class('FilterAction', '', [
...
call javaapi#class('BaselineResizeBehavior', '', [
...
call javaapi#class('SequencedEvent', '', [
...
call javaapi#class('SentEvent', '', [
  \ javaapi#method(0,'dispatch(', ')', 'void'),
  \ ])

call javaapi#class('DefaultKeyboardFocusManagerSentEvent', '', [
...
call javaapi#class('GraphicsCallback', '', [
  \ ])

call javaapi#class('PaintCallback', '', [
...
call javaapi#class('ImageMediaEntry', '', [
  \ javaapi#method(0,'imageUpdate(', 'Image, int, int, int, int, int)', 'boolean'),
  \ ])
...
call javaapi#class('ToolkitEventMulticaster', '', [
  \ javaapi#method(0,'eventDispatched(', 'AWTEvent)', 'void'),
  \ ])
...
call javaapi#class('AccessibleAWTComponent', '', [
  \ javaapi#method(0,'addPropertyChangeListener(', 'PropertyChangeListener)', 'void'),
  \ javaapi#method(0,'removePropertyChangeListener(', 'PropertyChangeListener)', 'void'),
...
call javaapi#class('AccessibleAWTContainer', '', [
  \ javaapi#method(0,'getAccessibleChildrenCount(', ')', 'int'),
  \ javaapi#method(0,'getAccessibleChild(', 'int)', 'Accessible'),
  \ javaapi#method(0,'getAccessibleAt(', 'Point)', 'Accessible'),
  \ javaapi#method(0,'addPropertyChangeListener(', 'PropertyChangeListener)', 'void'),
...
call javaapi#class('FlipBufferStrategy', '', [
  \ javaapi#method(0,'getCapabilities(', ')', 'BufferCapabilities'),
  \ javaapi#method(0,'getDrawGraphics(', ')', 'Graphics'),
  \ javaapi#method(0,'contentsLost(', ')', 'boolean'),
  \ javaapi#method(0,'contentsRestored(', ')', 'boolean'),
...
call javaapi#class('SystemColor', '', [
...
call javaapi#class('FlipContents', '', [
...
call javaapi#class('AccessibleAWTButton', '', [
  \ javaapi#method(0,'getAccessibleName(', ')', 'String'),
...
call javaapi#class('AccessibleAWTCanvas', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])

call javaapi#class('AccessibleAWTCheckbox', '', [
...
call javaapi#class('AccessibleAWTCheckboxMenuItem', '', [
  \ javaapi#method(0,'getAccessibleAction(', ')', 'AccessibleAction'),
  \ javaapi#method(0,'getAccessibleValue(', ')', 'AccessibleValue'),
  \ javaapi#method(0,'getAccessibleActionCount(', ')', 'int'),
  \ javaapi#method(0,'getAccessibleActionDescription(', 'int)', 'String'),
...
call javaapi#class('CheckboxMenuItem', '', [
...
call javaapi#class('AccessibleAWTChoice', '', [
...
call javaapi#class('FlipSubRegionBufferStrategy', '', [
  \ javaapi#method(0,'show(', 'int, int, int, int)', 'void'),
  \ javaapi#method(0,'showIfNotLost(', 'int, int, int, int)', 'boolean'),
  \ ])

call javaapi#class('ProxyCapabilities', '', [
  \ ])

call javaapi#class('SingleBufferStrategy', '', [
...
call javaapi#class('AccessibleAWTDialog', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ ])
...
call javaapi#class('FontAccessImpl', '', [
...
call javaapi#class('FontFormatException', '', [
...
call javaapi#class('AccessibleAWTFrame', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ ])
...
call javaapi#class('PaintAllCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PaintHeavyweightComponentsCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PeerPaintCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PeerPrintCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PrintAllCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PrintCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])

call javaapi#class('PrintHeavyweightComponentsCallback', '', [
  \ javaapi#method(0,'run(', 'Component, Graphics)', 'void'),
  \ ])
...
call javaapi#class('DefaultBufferCapabilities', '', [
...
call javaapi#class('WindowTranslucency', '', [
...
call javaapi#class('DestinationType', '', [
...
call javaapi#class('MultipleDocumentHandlingType', '', [
...
call javaapi#class('AccessibleAWTLabel', '', [
...
call javaapi#class('LinearGradientPaint', '', [
...
call javaapi#class('LinearGradientPaintContext', '', [
  \ ])

call javaapi#class('AccessibleAWTListChild', '', [
...
call javaapi#class('AccessibleAWTList', '', [
...
call javaapi#class('AccessibleAWTMenu', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])

call javaapi#class('AccessibleAWTMenuBar', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])
...
call javaapi#class('AccessibleAWTMenuComponent', '', [
  \ javaapi#method(0,'getAccessibleSelection(', ')', 'AccessibleSelection'),
  \ javaapi#method(0,'getAccessibleName(', ')', 'String'),
  \ javaapi#method(0,'getAccessibleDescription(', ')', 'String'),
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
...
call javaapi#class('AccessibleAWTMenuItem', '', [
  \ javaapi#method(0,'getAccessibleName(', ')', 'String'),
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleAction(', ')', 'AccessibleAction'),
  \ javaapi#method(0,'getAccessibleValue(', ')', 'AccessibleValue'),
...
call javaapi#class('ApplicationModalEventFilter', '', [
  \ ])

call javaapi#class('DocumentModalEventFilter', '', [
  \ ])

call javaapi#class('ToolkitModalEventFilter', '', [
  \ ])
...
call javaapi#class('ColorSpaceType', '', [
...
call javaapi#class('CycleMethod', '', [
...
call javaapi#class('OrientationRequestedType', '', [
...
call javaapi#class('PrintQualityType', '', [
...
call javaapi#class('AccessibleAWTPanel', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])
...
call javaapi#class('AccessibleAWTPopupMenu', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])
...
call javaapi#class('RadialGradientPaint', '', [
...
call javaapi#class('RadialGradientPaintContext', '', [
  \ ])
...
call javaapi#class('AccessibleAWTScrollPane', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ ])
...
call javaapi#class('AccessibleAWTScrollBar', '', [
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleValue(', ')', 'AccessibleValue'),
  \ javaapi#method(0,'getCurrentAccessibleValue(', ')', 'Number'),
...
call javaapi#class('AccessibleAWTTextArea', '', [
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ ])

call javaapi#class('TextArea', '', [
...
call javaapi#class('AccessibleAWTTextComponent', '', [
...
call javaapi#class('TextComponent', '', [
  \ javaapi#method(0,'enableInputMethods(', 'boolean)', 'void'),
  \ javaapi#method(0,'getInputMethodRequests(', ')', 'InputMethodRequests'),
  \ javaapi#method(0,'addNotify(', ')', 'void'),
  \ javaapi#method(0,'removeNotify(', ')', 'void'),
...
call javaapi#class('AccessibleAWTTextField', '', [
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ ])

call javaapi#class('TextField', '', [
...
call javaapi#class('DesktopPropertyChangeSupport', '', [
...
call javaapi#class('MessageType', '', [
...
call javaapi#class('AccessibleAWTWindow', '', [
  \ javaapi#method(0,'getAccessibleRole(', ')', 'AccessibleRole'),
  \ javaapi#method(0,'getAccessibleStateSet(', ')', 'AccessibleStateSet'),
  \ ])
