...
call javaapi#class('AffineTransformOp', '', [
  \ javaapi#method(1,'TYPE_NEAREST_NEIGHBOR', '', 'int'),
  \ javaapi#method(1,'TYPE_BILINEAR', '', 'int'),
  \ javaapi#method(1,'TYPE_BICUBIC', '', 'int'),
  \ javaapi#method(0,'AffineTransformOp(', 'AffineTransform, RenderingHints)', ''),
  \ javaapi#method(0,'AffineTransformOp(', 'AffineTransform, int)', ''),
...
call javaapi#class('AreaAveragingScaleFilter', 'ReplicateScaleFilter', [
  \ javaapi#method(0,'AreaAveragingScaleFilter(', 'int, int)', ''),
...
call javaapi#class('BandCombineOp', '', [
  \ javaapi#method(0,'BandCombineOp(', 'float[][], RenderingHints)', ''),
...
call javaapi#class('BandedSampleModel', 'ComponentSampleModel', [
  \ javaapi#method(0,'BandedSampleModel(', 'int, int, int, int)', ''),
  \ javaapi#method(0,'BandedSampleModel(', 'int, int, int, int, int[], int[])', ''),
...
call javaapi#class('BufferStrategy', '', [
  \ javaapi#method(0,'BufferStrategy(', ')', ''),
...
call javaapi#class('BufferedImage', 'Image', [
  \ javaapi#method(1,'TYPE_CUSTOM', '', 'int'),
  \ javaapi#method(1,'TYPE_INT_RGB', '', 'int'),
  \ javaapi#method(1,'TYPE_INT_ARGB', '', 'int'),
  \ javaapi#method(1,'TYPE_INT_ARGB_PRE', '', 'int'),
  \ javaapi#method(1,'TYPE_INT_BGR', '', 'int'),
  \ javaapi#method(1,'TYPE_3BYTE_BGR', '', 'int'),
  \ javaapi#method(1,'TYPE_4BYTE_ABGR', '', 'int'),
  \ javaapi#method(1,'TYPE_4BYTE_ABGR_PRE', '', 'int'),
  \ javaapi#method(1,'TYPE_USHORT_565_RGB', '', 'int'),
  \ javaapi#method(1,'TYPE_USHORT_555_RGB', '', 'int'),
  \ javaapi#method(1,'TYPE_BYTE_GRAY', '', 'int'),
  \ javaapi#method(1,'TYPE_USHORT_GRAY', '', 'int'),
  \ javaapi#method(1,'TYPE_BYTE_BINARY', '', 'int'),
  \ javaapi#method(1,'TYPE_BYTE_INDEXED', '', 'int'),
  \ javaapi#method(0,'BufferedImage(', 'int, int, int)', ''),
  \ javaapi#method(0,'BufferedImage(', 'int, int, int, IndexColorModel)', ''),
  \ javaapi#method(0,'BufferedImage(', 'ColorModel, WritableRaster, boolean, Hashtable<?, ?>)', ''),
  ...
  \ javaapi#method(0,'setRGB(', 'int, int, int) // [synchronized] ', 'void'),
...
call javaapi#class('BufferedImageFilter', 'ImageFilter', [
  \ javaapi#method(0,'BufferedImageFilter(', 'BufferedImageOp)', ''),
...
call javaapi#class('ByteLookupTable', 'LookupTable', [
  \ javaapi#method(0,'ByteLookupTable(', 'int, byte[][])', ''),
  \ javaapi#method(0,'ByteLookupTable(', 'int, byte[])', ''),
...
call javaapi#class('ColorConvertOp', '', [
  \ javaapi#method(0,'ColorConvertOp(', 'RenderingHints)', ''),
  \ javaapi#method(0,'ColorConvertOp(', 'ColorSpace, RenderingHints)', ''),
  \ javaapi#method(0,'ColorConvertOp(', 'ColorSpace, ColorSpace, RenderingHints)', ''),
  \ javaapi#method(0,'ColorConvertOp(', 'ICC_Profile[], RenderingHints)', ''),
...
call javaapi#class('ColorModel', '', [
  ...
  \ javaapi#method(0,'ColorModel(', 'int)', ''),
...
call javaapi#class('ComponentColorModel', 'ColorModel', [
  \ javaapi#method(0,'ComponentColorModel(', 'ColorSpace, int[], boolean, boolean, int, int)', ''),
  \ javaapi#method(0,'ComponentColorModel(', 'ColorSpace, boolean, boolean, int, int)', ''),
  \ javaapi#method(0,'getRed(', 'int)', 'int'),
  \ javaapi#method(0,'getGreen(', 'int)', 'int'),
  \ javaapi#method(0,'getBlue(', 'int)', 'int'),
  \ javaapi#method(0,'getAlpha(', 'int)', 'int'),
...
call javaapi#class('ComponentSampleModel', 'SampleModel', [
  \ javaapi#method(0,'ComponentSampleModel(', 'int, int, int, int, int, int[])', ''),
  \ javaapi#method(0,'ComponentSampleModel(', 'int, int, int, int, int, int[], int[])', ''),
  \ javaapi#method(0,'createCompatibleSampleModel(', 'int, int)', 'SampleModel'),
  \ javaapi#method(0,'createSubsetSampleModel(', 'int[])', 'SampleModel'),
  \ javaapi#method(0,'createDataBuffer(', ')', 'DataBuffer'),
...
call javaapi#class('ConvolveOp', '', [
  \ javaapi#method(1,'EDGE_ZERO_FILL', '', 'int'),
  \ javaapi#method(1,'EDGE_NO_OP', '', 'int'),
  \ javaapi#method(0,'ConvolveOp(', 'Kernel, int, RenderingHints)', ''),
  \ javaapi#method(0,'ConvolveOp(', 'Kernel)', ''),
...
call javaapi#class('CropImageFilter', 'ImageFilter', [
  \ javaapi#method(0,'CropImageFilter(', 'int, int, int, int)', ''),
...
call javaapi#class('DataBuffer', '', [
  \ javaapi#method(1,'TYPE_BYTE', '', 'int'),
  \ javaapi#method(1,'TYPE_USHORT', '', 'int'),
  \ javaapi#method(1,'TYPE_SHORT', '', 'int'),
  \ javaapi#method(1,'TYPE_INT', '', 'int'),
  \ javaapi#method(1,'TYPE_FLOAT', '', 'int'),
  \ javaapi#method(1,'TYPE_DOUBLE', '', 'int'),
  \ javaapi#method(1,'TYPE_UNDEFINED', '', 'int'),
...
call javaapi#class('DataBufferByte', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferByte(', 'int)', ''),
  \ javaapi#method(0,'DataBufferByte(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferByte(', 'byte[], int)', ''),
  \ javaapi#method(0,'DataBufferByte(', 'byte[], int, int)', ''),
  \ javaapi#method(0,'DataBufferByte(', 'byte[][], int)', ''),
  \ javaapi#method(0,'DataBufferByte(', 'byte[][], int, int[])', ''),
...
call javaapi#class('DataBufferDouble', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferDouble(', 'int)', ''),
  \ javaapi#method(0,'DataBufferDouble(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferDouble(', 'double[], int)', ''),
  \ javaapi#method(0,'DataBufferDouble(', 'double[], int, int)', ''),
  \ javaapi#method(0,'DataBufferDouble(', 'double[][], int)', ''),
  \ javaapi#method(0,'DataBufferDouble(', 'double[][], int, int[])', ''),
...
call javaapi#class('DataBufferFloat', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferFloat(', 'int)', ''),
  \ javaapi#method(0,'DataBufferFloat(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferFloat(', 'float[], int)', ''),
  \ javaapi#method(0,'DataBufferFloat(', 'float[], int, int)', ''),
  \ javaapi#method(0,'DataBufferFloat(', 'float[][], int)', ''),
  \ javaapi#method(0,'DataBufferFloat(', 'float[][], int, int[])', ''),
...
call javaapi#class('DataBufferInt', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferInt(', 'int)', ''),
  \ javaapi#method(0,'DataBufferInt(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferInt(', 'int[], int)', ''),
  \ javaapi#method(0,'DataBufferInt(', 'int[], int, int)', ''),
  \ javaapi#method(0,'DataBufferInt(', 'int[][], int)', ''),
  \ javaapi#method(0,'DataBufferInt(', 'int[][], int, int[])', ''),
...
call javaapi#class('DataBufferShort', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferShort(', 'int)', ''),
  \ javaapi#method(0,'DataBufferShort(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferShort(', 'short[], int)', ''),
  \ javaapi#method(0,'DataBufferShort(', 'short[], int, int)', ''),
  \ javaapi#method(0,'DataBufferShort(', 'short[][], int)', ''),
  \ javaapi#method(0,'DataBufferShort(', 'short[][], int, int[])', ''),
...
call javaapi#class('DataBufferUShort', 'DataBuffer', [
  \ javaapi#method(0,'DataBufferUShort(', 'int)', ''),
  \ javaapi#method(0,'DataBufferUShort(', 'int, int)', ''),
  \ javaapi#method(0,'DataBufferUShort(', 'short[], int)', ''),
  \ javaapi#method(0,'DataBufferUShort(', 'short[], int, int)', ''),
  \ javaapi#method(0,'DataBufferUShort(', 'short[][], int)', ''),
  \ javaapi#method(0,'DataBufferUShort(', 'short[][], int, int[])', ''),
  \ javaapi#method(0,'getData(', ')', 'short[]'),
  \ javaapi#method(0,'getData(', 'int)', 'short[]'),
...
call javaapi#class('DirectColorModel', 'PackedColorModel', [
  \ javaapi#method(0,'DirectColorModel(', 'int, int, int, int)', ''),
  \ javaapi#method(0,'DirectColorModel(', 'int, int, int, int, int)', ''),
  \ javaapi#method(0,'DirectColorModel(', 'ColorSpace, int, int, int, int, int, boolean, int)', ''),
...
call javaapi#class('FilteredImageSource', '', [
  \ javaapi#method(0,'FilteredImageSource(', 'ImageProducer, ImageFilter)', ''),
...
call javaapi#interface('ImageConsumer', '', [
  \ javaapi#method(1,'RANDOMPIXELORDER', '', 'int'),
  \ javaapi#method(1,'TOPDOWNLEFTRIGHT', '', 'int'),
  \ javaapi#method(1,'COMPLETESCANLINES', '', 'int'),
  \ javaapi#method(1,'SINGLEPASS', '', 'int'),
  \ javaapi#method(1,'SINGLEFRAME', '', 'int'),
  \ javaapi#method(1,'IMAGEERROR', '', 'int'),
  \ javaapi#method(1,'SINGLEFRAMEDONE', '', 'int'),
  \ javaapi#method(1,'STATICIMAGEDONE', '', 'int'),
  \ javaapi#method(1,'IMAGEABORTED', '', 'int'),
  \ javaapi#method(0,'setDimensions(', 'int, int)', 'void'),
  \ javaapi#method(0,'setProperties(', 'Hashtable<?, ?>)', 'void'),
  \ javaapi#method(0,'setColorModel(', 'ColorModel)', 'void'),
  \ javaapi#method(0,'setHints(', 'int)', 'void'),
...
call javaapi#class('ImageFilter', '', [
  \ javaapi#method(0,'ImageFilter(', ')', ''),
...
call javaapi#interface('ImageObserver', '', [
  \ javaapi#method(1,'WIDTH', '', 'int'),
  \ javaapi#method(1,'HEIGHT', '', 'int'),
  \ javaapi#method(1,'PROPERTIES', '', 'int'),
  \ javaapi#method(1,'SOMEBITS', '', 'int'),
  \ javaapi#method(1,'FRAMEBITS', '', 'int'),
  \ javaapi#method(1,'ALLBITS', '', 'int'),
  \ javaapi#method(1,'ERROR', '', 'int'),
  \ javaapi#method(1,'ABORT', '', 'int'),
...
call javaapi#class('ImagingOpException', 'RuntimeException', [
  \ javaapi#method(0,'ImagingOpException(', 'String)', ''),
  \ ])

call javaapi#class('IndexColorModel', 'ColorModel', [
  \ javaapi#method(0,'IndexColorModel(', 'int, int, byte[], byte[], byte[])', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, byte[], byte[], byte[], int)', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, byte[], byte[], byte[], byte[])', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, byte[], int, boolean)', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, byte[], int, boolean, int)', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, int[], int, boolean, int, int)', ''),
  \ javaapi#method(0,'IndexColorModel(', 'int, int, int[], int, int, BigInteger)', ''),
  \ javaapi#method(0,'getTransparency(', ')', 'int'),
  \ javaapi#method(0,'getComponentSize(', ')', 'int[]'),
  ...
  \ javaapi#method(0,'getAlpha(', 'int)', 'int'),
  \ javaapi#method(0,'getRGB(', 'int)', 'int'),
  \ javaapi#method(0,'getDataElements(', 'int, Object) // [synchronized] ', 'Object'),
  \ javaapi#method(0,'getComponents(', 'int, int[], int)', 'int[]'),
  \ javaapi#method(0,'getComponents(', 'Object, int[], int)', 'int[]'),
  \ javaapi#method(0,'getDataElement(', 'int[], int)', 'int'),
  \ javaapi#method(0,'getDataElements(', 'int[], int, Object)', 'Object'),
...
call javaapi#class('Kernel', '', [
  \ javaapi#method(0,'Kernel(', 'int, int, float[])', ''),
...
call javaapi#class('LookupOp', '', [
  \ javaapi#method(0,'LookupOp(', 'LookupTable, RenderingHints)', ''),
...
call javaapi#class('MemoryImageSource', '', [
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, ColorModel, byte[], int, int)', ''),
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, ColorModel, byte[], int, int, Hashtable<?, ?>)', ''),
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, ColorModel, int[], int, int)', ''),
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, ColorModel, int[], int, int, Hashtable<?, ?>)', ''),
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, int[], int, int)', ''),
  \ javaapi#method(0,'MemoryImageSource(', 'int, int, int[], int, int, Hashtable<?, ?>)', ''),
  \ javaapi#method(0,'addConsumer(', 'ImageConsumer) // [synchronized] ', 'void'),
  \ javaapi#method(0,'isConsumer(', 'ImageConsumer) // [synchronized] ', 'boolean'),
  \ javaapi#method(0,'removeConsumer(', 'ImageConsumer) // [synchronized] ', 'void'),
  \ javaapi#method(0,'startProduction(', 'ImageConsumer)', 'void'),
  \ javaapi#method(0,'requestTopDownLeftRightResend(', 'ImageConsumer)', 'void'),
  \ javaapi#method(0,'setAnimated(', 'boolean) // [synchronized] ', 'void'),
  \ javaapi#method(0,'setFullBufferUpdates(', 'boolean) // [synchronized] ', 'void'),
  \ javaapi#method(0,'newPixels(', ')', 'void'),
  \ javaapi#method(0,'newPixels(', 'int, int, int, int) // [synchronized] ', 'void'),
  \ javaapi#method(0,'newPixels(', 'int, int, int, int, boolean) // [synchronized] ', 'void'),
  \ javaapi#method(0,'newPixels(', 'byte[], ColorModel, int, int) // [synchronized] ', 'void'),
  \ javaapi#method(0,'newPixels(', 'int[], ColorModel, int, int) // [synchronized] ', 'void'),
  \ ])

call javaapi#class('MultiPixelPackedSampleModel', 'SampleModel', [
  \ javaapi#method(0,'MultiPixelPackedSampleModel(', 'int, int, int, int)', ''),
  \ javaapi#method(0,'MultiPixelPackedSampleModel(', 'int, int, int, int, int, int)', ''),
  \ javaapi#method(0,'createCompatibleSampleModel(', 'int, int)', 'SampleModel'),
  \ javaapi#method(0,'createDataBuffer(', ')', 'DataBuffer'),
  \ javaapi#method(0,'getNumDataElements(', ')', 'int'),
  \ javaapi#method(0,'getSampleSize(', ')', 'int[]'),
...
call javaapi#class('PackedColorModel', 'ColorModel', [
  \ javaapi#method(0,'PackedColorModel(', 'ColorSpace, int, int[], int, boolean, int, int)', ''),
  \ javaapi#method(0,'PackedColorModel(', 'ColorSpace, int, int, int, int, int, boolean, int, int)', ''),
...
call javaapi#class('PixelGrabber', '', [
  \ javaapi#method(0,'PixelGrabber(', 'Image, int, int, int, int, int[], int, int)', ''),
  \ javaapi#method(0,'PixelGrabber(', 'ImageProducer, int, int, int, int, int[], int, int)', ''),
  \ javaapi#method(0,'PixelGrabber(', 'Image, int, int, int, int, boolean)', ''),
  \ javaapi#method(0,'startGrabbing(', ') // [synchronized] ', 'void'),
  \ javaapi#method(0,'abortGrabbing(', ') // [synchronized] ', 'void'),
  \ javaapi#method(0,'grabPixels(', ') throws InterruptedException', 'boolean'),
  \ javaapi#method(0,'grabPixels(', 'long) throws InterruptedException // [synchronized] ', 'boolean'),
  \ javaapi#method(0,'getStatus(', ') // [synchronized] ', 'int'),
  \ javaapi#method(0,'getWidth(', ') // [synchronized] ', 'int'),
  \ javaapi#method(0,'getHeight(', ') // [synchronized] ', 'int'),
  \ javaapi#method(0,'getPixels(', ') // [synchronized] ', 'Object'),
  \ javaapi#method(0,'getColorModel(', ') // [synchronized] ', 'ColorModel'),
  \ javaapi#method(0,'setDimensions(', 'int, int)', 'void'),
  \ javaapi#method(0,'setHints(', 'int)', 'void'),
  \ javaapi#method(0,'setProperties(', 'Hashtable<?, ?>)', 'void'),
  \ javaapi#method(0,'setColorModel(', 'ColorModel)', 'void'),
  \ javaapi#method(0,'setPixels(', 'int, int, int, int, ColorModel, byte[], int, int)', 'void'),
  \ javaapi#method(0,'setPixels(', 'int, int, int, int, ColorModel, int[], int, int)', 'void'),
  \ javaapi#method(0,'imageComplete(', 'int) // [synchronized] ', 'void'),
  \ javaapi#method(0,'status(', ') // [synchronized] ', 'int'),
  \ ])

call javaapi#class('PixelInterleavedSampleModel', 'ComponentSampleModel', [
  \ javaapi#method(0,'PixelInterleavedSampleModel(', 'int, int, int, int, int, int[])', ''),
  \ javaapi#method(0,'createCompatibleSampleModel(', 'int, int)', 'SampleModel'),
  \ javaapi#method(0,'createSubsetSampleModel(', 'int[])', 'SampleModel'),
  \ javaapi#method(0,'hashCode(', ')', 'int'),
  \ ])
...
call javaapi#class('RGBImageFilter', 'ImageFilter', [
  \ javaapi#method(0,'RGBImageFilter(', ')', ''),
  \ javaapi#method(0,'setColorModel(', 'ColorModel)', 'void'),
...
call javaapi#class('RasterFormatException', 'RuntimeException', [
  \ javaapi#method(0,'RasterFormatException(', 'String)', ''),
  \ ])
...
call javaapi#class('ReplicateScaleFilter', 'ImageFilter', [
  \ javaapi#method(0,'ReplicateScaleFilter(', 'int, int)', ''),
  \ javaapi#method(0,'setProperties(', 'Hashtable<?, ?>)', 'void'),
  \ javaapi#method(0,'setDimensions(', 'int, int)', 'void'),
  \ javaapi#method(0,'setPixels(', 'int, int, int, int, ColorModel, byte[], int, int)', 'void'),
  \ javaapi#method(0,'setPixels(', 'int, int, int, int, ColorModel, int[], int, int)', 'void'),
...
call javaapi#class('RescaleOp', '', [
  \ javaapi#method(0,'RescaleOp(', 'float[], float[], RenderingHints)', ''),
  \ javaapi#method(0,'RescaleOp(', 'float, float, RenderingHints)', ''),
...
call javaapi#class('SampleModel', '', [
  \ javaapi#method(0,'SampleModel(', 'int, int, int, int)', ''),
  \ javaapi#method(0,'getWidth(', ')', 'int'),
  \ javaapi#method(0,'getHeight(', ')', 'int'),
  \ javaapi#method(0,'getNumBands(', ')', 'int'),
  \ javaapi#method(0,'getNumDataElements(', ')', 'int'),
...
call javaapi#class('ShortLookupTable', 'LookupTable', [
  \ javaapi#method(0,'ShortLookupTable(', 'int, short[][])', ''),
  \ javaapi#method(0,'ShortLookupTable(', 'int, short[])', ''),
...
call javaapi#class('SinglePixelPackedSampleModel', 'SampleModel', [
  \ javaapi#method(0,'SinglePixelPackedSampleModel(', 'int, int, int, int[])', ''),
  \ javaapi#method(0,'SinglePixelPackedSampleModel(', 'int, int, int, int, int[])', ''),
  \ javaapi#method(0,'getNumDataElements(', ')', 'int'),
  \ javaapi#method(0,'createCompatibleSampleModel(', 'int, int)', 'SampleModel'),
  \ javaapi#method(0,'createDataBuffer(', ')', 'DataBuffer'),
  \ javaapi#method(0,'getSampleSize(', ')', 'int[]'),
...
call javaapi#class('VolatileImage', 'Image', [
  \ javaapi#method(1,'IMAGE_OK', '', 'int'),
  \ javaapi#method(1,'IMAGE_RESTORED', '', 'int'),
  \ javaapi#method(1,'IMAGE_INCOMPATIBLE', '', 'int'),
  \ javaapi#method(0,'VolatileImage(', ')', ''),
